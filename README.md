...
| Ask something, or meet the other translators | [Join the Discord](https://discord.gg/vRQCMrrjtz) |
...
Requests and questions are welcome in the [Discord](https://discord.gg/vRQCMrrjtz) too, and you can ask for a language there rather than opening a form. Use a form when it should be tracked.
